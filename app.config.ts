...
import { mainnet, polygon, arbitrum, optimism, avalanche, gnosis, sonic, base, AppKitNetwork } from "@reown/appkit/networks";
...
// PONDER CLIENT (routed through frankencoin-api)
