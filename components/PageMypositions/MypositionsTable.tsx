			...
			{list.length > 0 && (
				<div className="mb-4 flex justify-end gap-2">
					<button
						...
						className="inline-flex items-center px-4 py-2 text-sm font-medium text-text-secondary bg-card-body-primary border border-card-body-seperator rounded-lg hover:bg-card-content-primary hover:text-text-primary transition-colors"
