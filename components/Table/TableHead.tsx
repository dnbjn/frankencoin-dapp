...
export default function TableHeader({ headers, subHeaders, actionCol, colSpan, tab = "", reverse = false, tabOnChange }: Props) {
	...
	return (
		<div className="table-sticky-head items-center justify-between rounded-t-lg bg-table-header-primary py-4 px-8 md:flex xl:px-12 border-b border-card-body-seperator">
