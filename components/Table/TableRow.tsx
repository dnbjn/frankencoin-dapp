...
export default function TableRow({
	...
	return (
		<div
			className={`${className} ${
				paddingY ?? "py-4"
			} odd:bg-table-row-primary even:bg-table-row-secondary md:hover:bg-table-row-hover cursor-default px-8 xl:px-12 border-t border-card-body-seperator last:rounded-b-lg duration-300`}
		>
